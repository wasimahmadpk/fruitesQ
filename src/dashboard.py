...
def analyse_image(image_bytes: bytes, filename: str, content_type: str, fruit_name: str):
    """Send image to API and display results in the sidebar."""
...
with st.sidebar:
    ...
    if input_mode == "Upload Image":
        ...
        camera_photo = st.camera_input("Point your camera at a fruit and snap a photo")
        if camera_photo:
            analyse_image(
